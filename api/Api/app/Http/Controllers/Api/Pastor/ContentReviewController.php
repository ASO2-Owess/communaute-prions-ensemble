...
class ContentReviewController extends Controller
{
    ...
    /** GET /api/pastor/contents — la file de relecture. */
    ...
    /**
     * GET /api/pastor/contents/{content}
     *
    ...
    /**
     * PUT /api/pastor/contents/{content}
     *
    ...
    /** POST /api/pastor/contents/{content}/approve */
    ...
    /** POST /api/pastor/contents/{content}/reject */
