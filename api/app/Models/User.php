...
/**
 * MustVerifyEmail est implemente, mais la verification n'est JAMAIS exigee
 * pour utiliser l'application : aucune route ne porte le middleware
 * 'verified'. Une adresse non confirmee rend seulement "mot de passe oublie"
 * inoperant — l'application le rappelle, elle ne bloque personne.
 */
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    /** Nos propres courriels, en francais, au lieu de ceux de Laravel. */
