...
class QuestionQueueController extends Controller
{
    ...
    /** GET /api/v1/pastor/questions — la file, du plus ancien au plus recent. */
    ...
    /** GET /api/v1/pastor/stats — le tableau de bord. */
    public function stats(): JsonResponse
    {
        return response()->json($this->pastoral->stats());
    }

    /** GET /api/v1/pastor/questions/{question} */
    ...
    /** POST /api/v1/pastor/questions/{question}/claim — prendre en charge. */
    ...
    /**
     * PUT /api/v1/pastor/questions/{question}/answer
     *
    ...
    /** POST /api/v1/pastor/questions/{question}/publish — publier un brouillon. */
